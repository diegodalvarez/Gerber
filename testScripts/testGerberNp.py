...
corr_diff = abs(gerber.corr() - rtns.corr())
cov_diff = abs(gerber.cov() - rtns.cov())
...
fig.suptitle("Absolute Difference between Gerber and Standard Calculation using NASDAQ1 100")
